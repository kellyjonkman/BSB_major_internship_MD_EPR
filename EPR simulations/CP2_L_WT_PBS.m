...
%% simulations 
[SimField1 SimSpec1] = garlic(Sys1,Exp);
...
spctotal = 0.1225*SimSpc1+0.8775*SimSpc2;
spctotal0 = (spctotal/max(spctotal));

spctotal01 = SimSpc1;
spctotal1 = 0.1225*(spctotal01/max(spctotal));

spctotal02 = SimSpc2;
spctotal2 = 0.8775*(spctotal02/max(spctotal));
...
ax = gca;
ax.FontSize = 25; 
%saveas(gcf,'C:\Users\keljo\Documents\Stage\easyspin\simulaties\figures\CP2_L_WT_PBS_sim','epsc')
%saveas(gcf,'C:\Users\keljo\Documents\Stage\easyspin\simulaties\figures\CP2_L_WT_PBS_sim.png')
...
ax = gca;
ax.FontSize = 25; 
%saveas(gcf,'C:\Users\keljo\Documents\Stage\easyspin\simulaties\figures\CP2_L_WT_PBS_sim2','epsc')
%saveas(gcf,'C:\Users\keljo\Documents\Stage\easyspin\simulaties\figures\CP2_L_WT_PBS_sim2.png')

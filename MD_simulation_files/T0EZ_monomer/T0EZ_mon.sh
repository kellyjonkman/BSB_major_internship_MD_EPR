...
#SBATCH -N 1
#SBATCH -t 99:00:00
#SBATCH -e T0EZ_mon.err
#SBATCH -o T0EZ_mon.out

module load 2020 GROMACS

# Go to working directory 
cd /home/kjonkman/T0EZ_monomer

# Convert PDB file into format readable by GROMACS
gmx pdb2gmx -f T0EZH_mon.pdb -o T0EZ_mon.gro -ff gromos54a7_atb -ter -missing <<EOF
2
2
1
EOF
...
#creating a box
gmx editconf -f T0EZ_mon.gro -o T0EZ_mon_box.gro -c -d 1.0 -bt cubic

gmx grompp -f minim.mdp -c T0EZ_mon_box.gro -p topol.top -o em_vac.tpr -maxwarn 3
gmx mdrun -deffnm em_vac -v

#solvate
gmx solvate -cp em_vac.gro -o T0EZ_mon_solv.gro -p topol.top

#adding ions
gmx grompp -f ions.mdp -c T0EZ_mon_solv.gro -p topol.top -o ions.tpr -maxwarn 3
gmx genion -s ions.tpr -o T0EZ_mon_solv_ions.gro -p topol.top -pname NA -nname CL -neutral <<EOF
13
EOF

# Energy minimisation
gmx grompp -f minim.mdp -c T0EZ_mon_solv_ions.gro -p topol.top -o em.tpr -maxwarn 3

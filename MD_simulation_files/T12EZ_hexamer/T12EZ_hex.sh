...
#SBATCH -N 1
#SBATCH -t 119:00:00
#SBATCH -e T12EZ_hex.err
#SBATCH -o T12EZ_hex.out
...
gmx pdb2gmx -f T12EZH_hex.pdb -o T12EZ_hex.gro -ff gromos54a7_atb -ter -missing <<EOF
2
1
1
1
...
#creating a box
gmx editconf -f T12EZ_hex.gro -o T12EZ_hex_box.gro -c -d 1.0 -bt cubic

gmx grompp -f minim.mdp -c T12EZ_hex_box.gro -p topol.top -o em_vac.tpr -maxwarn 3
gmx mdrun -deffnm em_vac -v

#solvate
gmx solvate -cp em_vac.gro -o T12EZ_hex_solv.gro -p topol.top

#adding ions
gmx grompp -f ions.mdp -c T12EZ_hex_solv.gro -p topol.top -o ions.tpr -maxwarn 3
gmx genion -s ions.tpr -o T12EZ_hex_solv_ions.gro -p topol.top -pname NA -nname CL -neutral <<EOF
13
EOF

# Energy minimisation
gmx grompp -f minim.mdp -c T12EZ_hex_solv_ions.gro -p topol.top -o em.tpr -maxwarn 3
...
gmx gyrate -s md_0_1.tpr -f md_0_1_noPBC3.xtc -o gyrate.xvg<<EOF
1
EOF

gmx distance -n index.ndx -f md_0_1_noPBC3.xtc -s md_0_1.tpr -oav -oall -select 'com of group CA_LEU_A plus com of group CA_LEU_D'

gmx rotacf -f md_0_1_noPBC3.xtc -P 1 -n index2.ndx -s md_0_1.tpr

gmx sasa -f md_0_1_noPBC3.xtc -s md_0_1.tpr -o -odg -or -tv <<EOF
1
1
EOF

...
#SBATCH -N 1
#SBATCH -t 119:00:00
#SBATCH -e K11V_mon.err
#SBATCH -o K11V_mon.out

module load 2020 GROMACS

# Go to working directory 
cd /home/kjonkman/K11V_monomer

# Convert PDB file into format readable by GROMACS
gmx pdb2gmx -f K11V_mon.pdb -o K11V_mon.gro -ff gromos54a7_atb -ter -missing <<EOF
2
1
1
EOF
...
#creating a box
gmx editconf -f K11V_mon.gro -o K11V_mon_box.gro -c -d 1.0 -bt cubic

gmx grompp -f minim.mdp -c K11V_mon_box.gro -p topol.top -o em_vac.tpr -maxwarn 3
gmx mdrun -deffnm em_vac -v

#solvate
gmx solvate -cp em_vac.gro -o K11V_mon_solv.gro -p topol.top

#adding ions
gmx grompp -f ions.mdp -c K11V_mon_solv.gro -p topol.top -o ions.tpr -maxwarn 3
gmx genion -s ions.tpr -o K11V_mon_solv_ions.gro -p topol.top -pname NA -nname CL -neutral <<EOF
13
EOF

# Energy minimisation
gmx grompp -f minim.mdp -c K11V_mon_solv_ions.gro -p topol.top -o em.tpr -maxwarn 3

...
with open('dist_dictionary.txt', 'w') as file:
    file.write(json.dumps(dict))

####### SAVE SNAPSHOTS PER BIN

filename2 = 'bindex_dist.ndx'
...
file = open('new_ener_dist.xvg','wt')
...
os.system("python PlotXVG.py new_ener_dist.xvg -o new_ener_dist.png")

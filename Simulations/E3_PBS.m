...
[Field,Spec] = eprload('E3_20201202_02.par'); %load the settings
...
spctotal = 0.16*SimSpc1+0.84*SimSpc2;
spctotal0 = (spctotal/max(spctotal));

spctotal01 = SimSpc1;
spctotal1 = 0.16*(spctotal01/max(spctotal));

spctotal02 = SimSpc2;
spctotal2 = 0.84*(spctotal02/max(spctotal));
...
ax = gca;
ax.FontSize = 25; 
%saveas(gcf,'C:\Users\keljo\Documents\Stage\easyspin\simulaties\figures\AB_WT_CP2_milliQ_sim_E3','epsc')
%saveas(gcf,'C:\Users\keljo\Documents\Stage\easyspin\simulaties\figures\AB_WT_CP2_milliQ_sim_E3.png')
...
ax = gca;
ax.FontSize = 25; 
%saveas(gcf,'C:\Users\keljo\Documents\Stage\easyspin\simulaties\figures\AB_WT_CP2_milliQ_sim2_E3','epsc')
%saveas(gcf,'C:\Users\keljo\Documents\Stage\easyspin\simulaties\figures\AB_WT_CP2_milliQ_sim2_E3.png')

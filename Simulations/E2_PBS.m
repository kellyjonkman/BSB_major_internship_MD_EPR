...
[Field,Spec] = eprload('E2_20201202_02.par'); %load the settings
...
spctotal = 0.325*SimSpc1+0.675*SimSpc2;
spctotal0 = (spctotal/max(spctotal));

spctotal01 = SimSpc1;
spctotal1 = 0.325*(spctotal01/max(spctotal));

spctotal02 = SimSpc2;
spctotal2 = 0.675*(spctotal02/max(spctotal));
...
ax = gca;
ax.FontSize = 25; 
%saveas(gcf,'C:\Users\keljo\Documents\Stage\easyspin\simulaties\figures\AB_WT_CP2_milliQ_sim_E2','epsc')
%saveas(gcf,'C:\Users\keljo\Documents\Stage\easyspin\simulaties\figures\AB_WT_CP2_milliQ_sim_E2.png')
...
ax = gca;
ax.FontSize = 25; 
%saveas(gcf,'C:\Users\keljo\Documents\Stage\easyspin\simulaties\figures\AB_WT_CP2_milliQ_sim2_E2','epsc')
%saveas(gcf,'C:\Users\keljo\Documents\Stage\easyspin\simulaties\figures\AB_WT_CP2_milliQ_sim2_E2.png')
